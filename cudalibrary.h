...
extern "C"
{
	...
	DLLEXPORT long cudaNeuralArrayAddValue(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralUnit value2);
	DLLEXPORT long cudaNeuralArraySubtract(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralArray* value2);
	DLLEXPORT long cudaNeuralArraySubtractValue(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralUnit value2);
	DLLEXPORT long cudaNeuralArrayMultiply(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralArray* value2);
	DLLEXPORT long cudaNeuralArrayMultiplyValue(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralUnit value2);
	DLLEXPORT long cudaNeuralArrayDivide(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralArray* value2);
	DLLEXPORT long cudaNeuralArrayDivideValue(cudaNeuralArray* result, cudaNeuralArray* value1, cudaNeuralUnit value2);
	...
	DLLEXPORT long cudaNeuralArrayGetSum(cudaNeuralArray* source, cudaNeuralUnit* result);
	DLLEXPORT long cudaNeuralArrayGetMean(cudaNeuralArray* source, cudaNeuralUnit* result);
	DLLEXPORT long cudaNeuralArrayGetMagnitude(cudaNeuralArray* source, cudaNeuralUnit* result);
	DLLEXPORT long cudaNeuralArrayGetDotProduct(cudaNeuralArray* source1, cudaNeuralArray* source2, cudaNeuralUnit* result);
	DLLEXPORT long cudaNeuralArrayGetEucledeanDistance(cudaNeuralArray* source1, cudaNeuralArray* source2, cudaNeuralUnit* result);
	DLLEXPORT long cudaNeuralArrayGetCosineSimilarity(cudaNeuralArray* source1, cudaNeuralArray* source2, cudaNeuralUnit* result);
	DLLEXPORT long cudaNeuralArrayNormalize(cudaNeuralArray* result, cudaNeuralArray* source);
	DLLEXPORT long cudaNeuralArrayShuffle(cudaNeuralArray* result);
	DLLEXPORT long cudaNeuralArrayConcatenate(cudaNeuralArray* result, cudaNeuralArray* source1, cudaNeuralArray* source2);
	DLLEXPORT long cudaNeuralArraySplit(cudaNeuralArray* result, cudaNeuralArray* source1, cudaNeuralArray* source2);
